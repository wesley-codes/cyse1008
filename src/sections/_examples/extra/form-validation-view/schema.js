...
export const FormSchema = zod
  .object({
    ...
    //
    checkbox: schemaHelper.boolean({
      message: { required_error: 'Checkbox is required!' },
    }),
    switch: schemaHelper.boolean({
      message: { required_error: 'Switch is required!' },
    }),
    //
    ...
    multiUpload: schemaHelper.files({
      message: { required_error: 'Multi upload is required!' },
    }),
  })
